...
const SingUpPage = () => {
    ...
    const handleSingUp = (e) => {
        ...
        if (!passwordRegex.test(password)) {
            toast.error("Password should be at least 8 characters long and include a combination of uppercase letters, lowercase letters, special characters, and numbers.");
            return;
        }
                                ...
                                <div className="bg-white rounded-xl shadow-2xl p-7 sm:p-10">
                                    ...
                                    <form onSubmit={handleSingUp}>
                                        ...
                                        <div className="mb-1 sm:mb-2 relative">
                                            ...
                                            />
                                            <span className="absolute right-5 top-10  cursor-pointer" onClick={() => { setShowPassword2(!showPassword2) }} >
                                                {
